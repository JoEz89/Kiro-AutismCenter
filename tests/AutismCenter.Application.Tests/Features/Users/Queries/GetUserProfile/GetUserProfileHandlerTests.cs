...
namespace AutismCenter.Application.Tests.Features.Users.Queries.GetUserProfile;
...
public class GetUserProfileHandlerTests
{
    ...
    public GetUserProfileHandlerTests()
    {
        ...
        _handler = new GetUserProfileHandler(_userRepositoryMock.Object);
    }

    [Fact]
    public async Task Handle_ExistingUser_ShouldReturnUserProfileDto()
    {
        // Arrange
