...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  const navigation: NavigationItem[] = [
    {
      ...
      icon: DashboardIcon,
      current: currentPath === '/admin/dashboard' || currentPath === '/admin',
    },
    {
    ...
    {
      name: t('admin.courses', 'Courses'),
      href: '/admin/courses',
      icon: CoursesIcon,
      current: currentPath.startsWith('/admin/courses'),
    },
    {
      name: t('admin.appointments', 'Appointments'),
      href: '/admin/appointments',
      icon: AppointmentsIcon,
      current: currentPath.startsWith('/admin/appointments'),
    },
    {
  ...
  return (
    <>
        ...
        <div className="flex min-h-0 flex-1 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            ...
            <div className="flex flex-shrink-0 items-center px-4">
              <Link to="/admin/dashboard" className="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            {/* Navigation */}
            <nav className="mt-5 flex-1 space-y-1 px-2" aria-label={t('admin.navigation', 'Admin navigation')}>
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      'group flex items-center px-2 py-2 text-sm font-medium rounded-md border-l-4 rtl:border-l-0 rtl:border-r-4 transition-colors'
                    )}
                  ...
                  >
                    <Icon
                      className={cn(
                        ...
                        'mr-3 rtl:mr-0 rtl:ml-3 flex-shrink-0 h-6 w-6'
                      )}
                    />
                    {item.name}
                  </Link>
      ...
      {/* Mobile sidebar */}
      <div className={cn(
        'lg:hidden fixed inset-y-0 z-50 flex w-64 flex-col transform transition-transform duration-300 ease-in-out',
        ...
        <div className="flex min-h-0 flex-1 flex-col bg-white dark:bg-gray-800">
          <div className="flex h-16 flex-shrink-0 items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              type="button"
              className="ml-1 rtl:ml-0 rtl:mr-1 flex h-10 w-10 items-center justify-center rounded-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
              onClick={onClose}
            >
              <span className="sr-only">{t('common.close', 'Close sidebar')}</span>
              <svg className="h-6 w-6 text-gray-600 dark:text-gray-300" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
