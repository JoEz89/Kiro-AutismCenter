...
export const LoginForm: React.FC<LoginFormProps> = ({ onSuccess, className }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setApiError(error.response?.data?.message || t('auth.invalidCredentials'));
    }
  };
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={isLoading}
              className={cn(
                'w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm',
