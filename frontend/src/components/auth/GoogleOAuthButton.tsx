...
export const GoogleOAuthButton: React.FC<GoogleOAuthButtonProps> = ({
  ...
  const buttonText = mode === 'login' ? t('auth.loginWithGoogle') : t('auth.registerWithGoogle');
  ...
  return (
    <button
      ...
      className={cn(
        'w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm',
