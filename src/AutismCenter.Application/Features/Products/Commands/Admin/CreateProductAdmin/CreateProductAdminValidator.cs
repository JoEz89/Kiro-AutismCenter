...
public class CreateProductAdminValidator : AbstractValidator<CreateProductAdminCommand>
{
    public CreateProductAdminValidator()
    {
        RuleFor(x => x.NameEn)
        ...
        RuleFor(x => x.ProductSku)
            ...
            .Matches(@"^[A-Z0-9-]+$").WithMessage("Product SKU must contain only uppercase letters, numbers, and hyphens");
