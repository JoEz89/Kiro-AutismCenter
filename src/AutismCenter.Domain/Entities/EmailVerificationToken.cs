...
public class EmailVerificationToken : BaseEntity
{
    ...
    private EmailVerificationToken(string token, Guid userId, DateTime expiryDate)
    {
        Token = token;
        UserId = userId;
    ...
    public static EmailVerificationToken Create(string token, Guid userId, int expirationHours = 24)
    {
